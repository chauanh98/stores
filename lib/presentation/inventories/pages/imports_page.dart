          ...
          IconButton(
            ...
            onPressed: () async {
              if (filterMode == ImportFilterMode.range) {
                ref.read(importFilterModeProvider.notifier).state =
                    ImportFilterMode.day;
                ...
                if (pickedRange != null) {
                  final start = DateTime(pickedRange.start.year,
                      pickedRange.start.month, pickedRange.start.day, 0, 0, 0);
                  final end = DateTime(
                      ...
                      59,
                      999);
                  ref.read(selectedImportRangeProvider.notifier).state =
                      TupleDateRange(start, end);
                }
              }
            },
          ),
                            ...
                            if (filterMode == ImportFilterMode.range) {
                              ...
                              if (pickedRange != null) {
                                ...
                                final end = DateTime(
                                    ...
                                    999);
                                ref
                                    .read(selectedImportRangeProvider.notifier)
                                    .state = TupleDateRange(start, end);
                              }
                            } else {
                              final picked = await showDatePicker(
                                context: context,
                              ...
                              if (picked != null) {
                                ref
                                    .read(selectedImportDateProvider.notifier)
                                    .state = picked;
                              }
                            }
                          },
    ...
    return ListTile(
      ...
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
              builder: (_) => ImportDetailPage(tx: tx, product: product)),
        );
      },
    );
  }
